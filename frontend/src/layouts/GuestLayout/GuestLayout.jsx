      ...
      <header className={styles.header}>
        <div className={styles.navContainer}>
          ...
          <nav className={`${styles.topNavLinks} ${isMenuOpen ? styles.navLinksOpen : ''}`}>
            <NavLink to="/hotels" className={styles.navLink} onClick={() => setIsMenuOpen(false)}>Hotels</NavLink>
            <NavLink to="/guest/reservations" className={styles.navLink} onClick={() => setIsMenuOpen(false)}>Reservations</NavLink>
            <NavLink to="/guest/profile" className={styles.navLink} onClick={() => setIsMenuOpen(false)}>Profile</NavLink>
